...
function StudentProfile() {
  ...
  const [profile, setProfile] = useState({ full_name: '', email: '', phone_number: '', role: '', department: 'Learner' });
  ...
  const fetchProfile = async () => {
    try {
      ...
      const type = sessionStorage.getItem("learnerType")?.toUpperCase() || "";
      const displayRole = type === "STUDENT" ? "Student" : type === "EMPLOYEE" ? "Employee" : "Learner";
            ...
            <div className="sticky top-6 flex flex-col gap-6 max-h-[calc(100vh-2rem)] overflow-y-auto hide-scrollbar pb-2">
              ...
              <div className="px-6 pb-6 flex flex-col items-center relative">
                ...
                <div className="mt-14 text-center mb-6">
                  <h3 className="text-xl font-bold text-slate-800 leading-tight">{profile.full_name || (sessionStorage.getItem("learnerType")?.toUpperCase() === "STUDENT" ? "Student" : sessionStorage.getItem("learnerType")?.toUpperCase() === "EMPLOYEE" ? "Employee" : "Learner")}</h3>
